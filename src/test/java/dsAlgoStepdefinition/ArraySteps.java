...
public class ArraySteps {
	...
	public void the_user_should_navigated_to_the_options_and_in_array_page(String Sheetname, Integer rownumber) {
		arrayPage.ArrayOptions(Sheetname, rownumber);
		try {
			log.info("Verifying navigation to the option: " + Sheetname + " and row number: " + rownumber
					+ " on Array page.");
	...
	public void the_user_enters_code_and_from_tryeditor_and_clicks_the_run_button(String code, String Sheetname,
			Integer rowNumber) {
	...
	public void the_user_should_able_to_see_an_error_message_in_alert_window_and(String Sheetname, Integer RowNumber)
			throws IOException {
	...
	public void the_user_should_see_an_output_for_question_in_console_for_and(String Sheetname, Integer RowNumber)
			throws IOException {
