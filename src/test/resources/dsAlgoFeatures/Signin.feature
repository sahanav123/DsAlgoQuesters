...
#
    #Scenario: Verify the user gets error message without entering Username and Password when clicking on login button
...
#
    #Scenario: Verify the user gets error message giving username without entering Password when clicking on login button
    #Given The user is on the Login Page 
...
#
    #Scenario: Verify the user gets error message without entering username and giving Password when clicking on login button
    #Given The user is on the Login Page 
    #When User clicks on Login link on Login page without entering username and giving password 
    #Then The user should get error message "Please fill out this field" is displayed in Password textbox 
#
    #Scenario: Verify the user gets error message giving invalid username and valid Password when clicking on login button
    #Given The user is on the Login Page 
...
#
    #Scenario: Verify the user gets error message giving valid username and invalid Password when clicking on login button
    #Given The user is on the Login Page 
    #When User enters valid username and invalid password and clicks Login button
    #Then The user should get error message "Invalid username and Password " is displayed in Login screen
#
    #Scenario: Verify the user gets error message giving invalid username and invalid Password when clicking on login button
    #Given The user is on the Login Page 
...
#
    #Scenario: Verify the user is able to login  giving valid username and valid password when clicking on login button
    #Given The user is on the Login Page 
...
#
    #Scenario: Verify the user is able to see DataStructures dropdown with the below options after signin:-
   #Arrays
   #Linked List
   #Stack
   #Queue
