Feature: Register functionality
    ...
    Scenario: Verify that user gets error message without 
entering username , password and
 password confirmation when clicking on register button 
    ...
    Scenario: Verify that user gets error message giving username without 
entering  password and password confirmation 
when clicking on register button 
    ...
    Scenario: Verify that user gets error message giving username and 
password  without entering   password confirmation 
when clicking on register button 
    Given The user is on the register page 
    ...
    Scenario: Verify that user gets error message giving username and 
entering password and password confirmation 
different when clicking on register button
    Given The user is on the register page 
    ...
    Scenario: Verify that user gets error message giving invalid username 
like %,$,& (Example:  Tom$, Tom%) when clicking on register button
    Given The user is on the register page 
    ...
    Scenario: Verify that user gets error message while entering the 
password less than 8 characters when clicking on register button 
    Given The user is on the register page 
    When The user enters the password less than 8 characters and clicks "Register" button
    Then The user should get error message and not redirected to the home page 

    Scenario: Verify that user gets erroe mesage when 
entering only numeric when clicking on register button
    Given The user is on the register page 
    When The user enters the password only numeric and clicks "Register" 
    Then The user should get error message and not redirected to the home page 

    Scenario: Verify that user is able to login after entering valid username ,
password and password confirmation when clicking on register button
    Given The user is on the register page 
    ...
    Scenario: Verify that user is able to see logged in ID and sign out links on
 top corner of the home page 
    ...
    Scenario: Verify that user is able to see Register and sign in links 
when clicking on signout link
    ...
    Scenario: Verify that user is able to login to DSAlgo after 
doing successful registration 
    Given The user is on home page 
